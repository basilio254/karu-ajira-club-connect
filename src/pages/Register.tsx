...
const Register = () => {
  ...
  return <div className="min-h-screen bg-gray-50 pt-24 pb-16">
        ...
        <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid gap-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input id="phone" name="phone" type="tel" value={formData.phone} onChange={handleChange} placeholder="+254 712 345 678" required />
                    </div>
          ...
          {step === 2 && !paymentCompleted && <Card>
              ...
              <CardContent>
                ...
                <Button className="w-full mt-6 bg-ajira-blue hover:bg-ajira-lightBlue" onClick={handlePayment} disabled={isLoading}>
                  {isLoading ? <>
